...
<section class="vbox">
  ...
  <link rel="stylesheet" href="/excavator/Public/Admin/js/prettyphoto/prettyPhoto.css" type="text/css" cache="false" />
  <link rel="stylesheet" href="/excavator/Public/Admin/js/grid/gallery.css" type="text/css" cache="false" />
  <script src="/excavator/Public/Admin/js/libs/underscore-min.js" cache="false"></script>
  <script src="/excavator/Public/Admin/js/prettyphoto/jquery.prettyPhoto.js" cache="false"></script>
  <script src="/excavator/Public/Admin/js/grid/jquery.grid-a-licious.min.js" cache="false"></script>
  <script src="/excavator/Public/Admin/js/grid/gallery.js" cache="false"></script>
  <section id="content">
    <section class="vbox bg-white">
      ...
      <section class="scrollable">
        <div class="text-center m-t-lg clearfix wrapper-lg animated fadeInRightBig" id="galleryLoading">
          ...
          <h3 class="text-muted">This gallery use Flickr api to load the photos</h3>
          <p class="m-t-lg"><i class="fa fa-spinner fa fa-spin fa fa-2x"></i></p>
        </div>
        <div id="gallery" class="gallery hide">
          <div class="item"> <img src="/excavator/Public/Admin/images/thumb_2.png" /> <a href="/excavator/Public/Admin/images/thumb_2.png" rel="prettyPhoto[gallery]"></a>
            <div class="desc">
              <h4>Teideal</h4>
              <p>Lorem ipsum dolor sit amet...</p>
              <span>2013-08-29 13:00:00</span> </div>
          </div>
        </div>
      </section>
    </section>
