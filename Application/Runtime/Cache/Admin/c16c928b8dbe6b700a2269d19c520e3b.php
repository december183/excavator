...
<section class="vbox">
    ...
    <link rel="stylesheet" href="/excavator/Public/Admin/js/select2/select2.css" type="text/css" cache="false" />
    <link rel="stylesheet" href="/excavator/Public/Admin/js/select2/theme.css" type="text/css" cache="false" />
    <link rel="stylesheet" href="/excavator/Public/Admin/js/fuelux/fuelux.css" type="text/css" cache="false" />
    <link rel="stylesheet" href="/excavator/Public/Admin/js/datepicker/datepicker.css" type="text/css" cache="false" />
    <link rel="stylesheet" href="/excavator/Public/Admin/js/slider/slider.css" type="text/css" cache="false" />
    <section id="content">
        <section class="vbox">
    ...
    <!-- datepicker -->
    <script src="/excavator/Public/Admin/js/datepicker/bootstrap-datepicker.js" cache="false"></script>
    <!-- slider -->
    <script src="/excavator/Public/Admin/js/slider/bootstrap-slider.js" cache="false"></script>
    <!-- file input -->
    <script src="/excavator/Public/Admin/js/file-input/bootstrap-filestyle.min.js" cache="false"></script>
    <!-- combodate -->
    <script src="/excavator/Public/Admin/js/libs/moment.min.js" cache="false"></script>
    <script src="/excavator/Public/Admin/js/combodate/combodate.js" cache="false"></script>
    <!-- select2 -->
    <script src="/excavator/Public/Admin/js/select2/select2.min.js" cache="false"></script>
    <!-- wysiwyg -->
    <script src="/excavator/Public/Admin/js/wysiwyg/jquery.hotkeys.js" cache="false"></script>
    <script src="/excavator/Public/Admin/js/wysiwyg/bootstrap-wysiwyg.js" cache="false"></script>
    <script src="/excavator/Public/Admin/js/wysiwyg/demo.js" cache="false"></script>
    <!-- markdown -->
    <script src="/excavator/Public/Admin/js/markdown/epiceditor.min.js" cache="false"></script>
    <script src="/excavator/Public/Admin/js/markdown/demo.js" cache="false"></script>
