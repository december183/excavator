...
<section class="vbox">
    ...
    <ul class="nav navbar-nav navbar-right hidden-xs nav-user">
        ...
        <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <span class="thumb-sm avatar pull-left"> <img src="/excavator/Public/Admin/images/avatar.jpg"> </span> John.Smith <b class="caret"></b> </a>
            <ul class="dropdown-menu animated fadeInRight">
                ...
                <li class="divider"></li>
                <li> <a href="/excavator/index.php?s=/Admin/Activity/logout" data-toggle="ajaxModal" >Logout</a> </li>
            </ul>
        </li>
    </ul>
</header>
    ...
    <!-- laydate -->
    <script type="text/javascript" src="/excavator/Plugins/laydate/laydate.dev.js"></script>
    <!--kindeditor-->
        ...
        <section class="vbox">
            <section class="scrollable padder">
                <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
                    ...
                    <li><a href="/excavator/index.php?s=/Admin/Activity/index">活动列表</a></li>
                    <li><a href="/excavator/index.php?s=/Admin/Activity/add">添加活动</a></li>
                    <li><a href="/excavator/index.php?s=/Admin/Activity/edit/id/<?php echo ($oneActive["id"]); ?>">修改活动</a></li>
                </ul>
                <div class="m-b-md">
                    ...
                    <div class="col-sm-6">
                        <section class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <form class="bs-example form-horizontal" id="ajaxForm" action="/excavator/index.php?s=/Admin/Activity/edit">
                                    <input type="hidden" name="id" value="<?php echo ($oneActive["id"]); ?>" />
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">活动名称</label>
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control" name="title" placeholder="Title" value="<?php echo ($oneActive["title"]); ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <select name="type" class="form-control m-b">
                                                <?php if(is_array($typelist)): $i = 0; $__LIST__ = $typelist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" <?php if($oneActive['type'] == $vo['id']): ?>selected="selected"<?php endif; ?>><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <select name="cateid" class="form-control m-b">
                                                <?php if(is_array($catelist)): $i = 0; $__LIST__ = $catelist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="0" <?php if($oneActive['cateid'] == 0): ?>selected="selected"<?php endif; ?>>全部分类</option>
                                                    <option value="<?php echo ($vo["id"]); ?>" <?php if($oneActive['cateid'] == $vo['id']): ?>selected="selected"<?php endif; ?>><?php echo ($vo["name"]); ?></option>
                                                    <?php if(is_array($vo['child'])): $i = 0; $__LIST__ = $vo['child'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$voo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($voo["id"]); ?>" <?php if($oneActive['cateid'] == $voo['id']): ?>selected="selected"<?php endif; ?>><?php echo ($voo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; endforeach; endif; else: echo "" ;endif; ?>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input name="starttime" id="starttime" class="input-sm input-s form-control" size="16" type="text" value="<?php echo ($oneActive["starttime"]); ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">结束时间</label>
                                        <div class="col-sm-10">
                                            <input name="endtime" id="endtime" class="input-sm input-s form-control" size="16" type="text" value="<?php echo ($oneActive["endtime"]); ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <a href="#" class="thumb-sm"><img src="<?php echo ($oneActive["thumbpic"]); ?>" class="img-rounded"></a>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">活动描述</label>
                                        <div class="col-sm-10">
                                            <textarea class="form-control" name="descript" rows="6" data-minwords="6" data-required="true" placeholder="Type the descript"><?php echo ($oneActive["descript"]); ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">活动详情</label>
                                        <div class="col-sm-10">
                                            <textarea class="form-control" name="content" id="editor"><?php echo ($oneActive["content"]); ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="radio-inline pad-lf-none">
                                                        <label class="radio-custom margin-lf-none">
                                                            <input type="radio" name="isrec" value="1" <?php if($oneActive['isrec'] == 1): ?>checked="checked"<?php endif; ?>>
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-offset-2 col-lg-10">
                                            <button type="submit" class="btn btn-sm btn-default" <?php if($oneActive['isrec'] == 0): ?>checked="checked"<?php endif; ?>>修改活动</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
    ...
    <script src="/excavator/Public/Admin/js/manage/index.js"></script>
