...
<section class="vbox">
  ...
  <link rel="stylesheet" href="/excavator/Public/Admin/js/intro/introjs.css" type="text/css" cache="false" />
  <script src="/excavator/Public/Admin/js/intro/intro.min.js" cache="false"></script>
  <script src="/excavator/Public/Admin/js/intro/demo.js" cache="false"></script>
  <section id="content">
    <section class="vbox">
      ...
      <section>
        <section class="hbox stretch">
          ...
          <aside class="bg-light b-l aside-md">
            <div class="wrapper bg-light" id="aside"> This is a aside content </div>
          </aside>
        </section>
      </section>
