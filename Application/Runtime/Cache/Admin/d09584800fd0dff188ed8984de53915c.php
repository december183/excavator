...
<section class="vbox">
    ...
    <ul class="nav navbar-nav navbar-right hidden-xs nav-user">
        ...
        <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <span class="thumb-sm avatar pull-left"> <img src="/excavator/Public/Admin/images/avatar.jpg"> </span> John.Smith <b class="caret"></b> </a>
            <ul class="dropdown-menu animated fadeInRight">
                ...
                <li class="divider"></li>
                <li> <a href="/excavator/index.php?s=/Admin/Machine/logout" data-toggle="ajaxModal" >Logout</a> </li>
            </ul>
        </li>
    </ul>
</header>
        ...
        <section class="vbox">
            <section class="scrollable padder">
                <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
                    ...
                    <li><a href="/excavator/index.php?s=/Admin/Machine/index">机型列表</a></li>
                    <li><a href="/excavator/index.php?s=/Admin/Machine/add">新增机型</a></li>
                    <li><a href="/excavator/index.php?s=/Admin/Machine/edit/id/<?php echo ($oneMachine["id"]); ?>">修改机型</a></li>
                </ul>
                <div class="m-b-md">
                    <h3 class="m-b-none">修改机型</h3>
                </div>
                <div class="row">
                    <div class="col-sm-6">
                        <section class="panel panel-default">
                            <header class="panel-heading font-bold">修改机型</header>
                            <div class="panel-body">
                                <form class="bs-example form-horizontal" id="ajaxForm" action="/excavator/index.php?s=/Admin/Machine/edit">
                                    <input type="hidden" name="id" value="<?php echo ($oneMachine["id"]); ?>" />
                                    <input type="hidden" id="brand" value="<?php echo ($oneMachine["brand"]); ?>" />
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">机器型号</label>
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control" name="machineno" placeholder="Machineno" value="<?php echo ($oneMachine["machineno"]); ?>">
                                            <span class="help-block m-b-none">机器型号不能小于2位.</span>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">机器分类</label>
                                        <div class="col-lg-10">
                                            <select name="cateid" id="cateid" class="form-control m-b">
                                                <option value="0">请选择机器分类</option>
                                                <?php if(is_array($catelist)): $i = 0; $__LIST__ = $catelist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" <?php if($oneMachine['cateid'] == $vo['id']): ?>selected="selected"<?php endif; ?>><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">机型图片</label>
                                        <div class="col-sm-10">
                                            ...
                                            <a href="#" class="thumb-sm"><img src="<?php echo ($oneMachine["thumbpic"]); ?>" class="img-rounded"></a>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-lg-offset-2 col-lg-10">
                                            <button type="submit" class="btn btn-sm btn-default">修改机型</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
    ...
    <script src="/excavator/Public/Admin/js/machine/index.js"></script>
