...
<section class="vbox">
    ...
    <ul class="nav navbar-nav navbar-right hidden-xs nav-user">
        ...
        <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <span class="thumb-sm avatar pull-left"> <img src="/excavator/Public/Admin/images/avatar.jpg"> </span> John.Smith <b class="caret"></b> </a>
            <ul class="dropdown-menu animated fadeInRight">
                ...
                <li class="divider"></li>
                <li> <a href="/excavator/index.php?s=/Admin/Auth/logout" data-toggle="ajaxModal" >Logout</a> </li>
            </ul>
        </li>
    </ul>
</header>
        ...
        <section class="vbox">
            <section class="scrollable padder">
                <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
                    ...
                    <li><a href="/excavator/index.php?s=/Admin/Auth/index">菜单列表</a></li>
                    <li><a href="/excavator/index.php?s=/Admin/Auth/add">添加菜单</a></li>
                    <li><a href="/excavator/index.php?s=/Admin/Auth/edit/id/<?php echo ($oneAuth["id"]); ?>">修改菜单</a></li>
                </ul>
                <div class="m-b-md">
                    <h3 class="m-b-none">修改菜单</h3>
                </div>
                <div class="row">
                    <div class="col-sm-6">
                        <section class="panel panel-default">
                            <header class="panel-heading font-bold">修改菜单</header>
                            <div class="panel-body">
                                <form class="bs-example form-horizontal" id="ajaxForm" action="/excavator/index.php?s=/Admin/Auth/edit">
                                    <input type="hidden" name="id" value="<?php echo ($oneAuth["id"]); ?>" />
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">菜单名称</label>
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control" name="name" placeholder="Name" value="<?php echo ($oneAuth["name"]); ?>">
                                            <span class="help-block m-b-none">名称不能小于2位.</span>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">图标样式</label>
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control" name="icon" placeholder="Icon" value="<?php echo ($oneAuth["icon"]); ?>">
                                            <span class="help-block m-b-none">菜单左侧样式字符串.</span>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">菜单操作</label>
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control" name="action" placeholder="Action" value="<?php echo ($oneAuth["action"]); ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">上级节点</label>
                                        <div class="col-lg-10">
                                            <select name="pid" class="form-control m-b">
                                                <option value="0" <?php if($oneAuth['pid'] == 0): ?>selected="selected"<?php endif; ?>>顶级菜单</option>
                                                <?php if(is_array($itemlist)): $i = 0; $__LIST__ = $itemlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" <?php if($oneAuth['pid'] == $vo['id']): ?>selected="selected"<?php endif; ?>><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="radio-inline pad-lf-none">
                                                        <label class="radio-custom margin-lf-none">
                                                            <input type="radio" name="isauth" value="1" <?php if($oneAuth['isauth'] == 1): ?>checked="checked"<?php endif; ?>>
                                                            <i class="fa fa-circle-o"></i> 是 </label>
                                                    </div>
                                                    <div class="radio-inline pad-lf-none">
                                                        <label class="radio-custom margin-lf-none">
                                                            <input type="radio" name="isauth" value="0" <?php if($oneAuth['isauth'] == 0): ?>checked="checked"<?php endif; ?>>
                                        ...
                                        <div class="col-sm-10">
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="radio-inline pad-lf-none">
                                                        <label class="radio-custom margin-lf-none">
                                                            <input type="radio" name="status" value="1" <?php if($oneAuth['status'] == 1): ?>checked="checked"<?php endif; ?>>
                                                            <i class="fa fa-circle-o"></i> 是 </label>
                                                    </div>
                                                    <div class="radio-inline pad-lf-none">
                                                        <label class="radio-custom margin-lf-none">
                                                            <input type="radio" name="status" value="0" <?php if($oneAuth['status'] == 0): ?>checked="checked"<?php endif; ?>>
                                                            <i class="fa fa-circle-o"></i> 否 </label>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-offset-2 col-lg-10">
                                            <button type="submit" class="btn btn-sm btn-default">修改菜单</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
    ...
    <script src="/excavator/Public/Admin/js/auth/index.js"></script>
