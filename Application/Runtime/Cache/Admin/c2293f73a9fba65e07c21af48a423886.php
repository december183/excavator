...
<section class="vbox">
    ...
    <ul class="nav navbar-nav navbar-right hidden-xs nav-user">
        ...
        <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <span class="thumb-sm avatar pull-left"> <img src="/excavator/Public/Admin/images/avatar.jpg"> </span> John.Smith <b class="caret"></b> </a>
            <ul class="dropdown-menu animated fadeInRight">
                ...
                <li class="divider"></li>
                <li> <a href="/excavator/index.php/Admin/AdverType/logout" data-toggle="ajaxModal" >Logout</a> </li>
            </ul>
        </li>
    </ul>
</header>
        ...
        <section class="vbox">
            <section class="scrollable padder">
                <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
                    ...
                    <li><a href="/excavator/index.php/Admin/AdverType/index">广告类型列表</a></li>
                    <li><a href="/excavator/index.php/Admin/AdverType/add">添加广告类型</a></li>
                </ul>
                <div class="m-b-md">
                    <h3 class="m-b-none">添加广告类型</h3>
                </div>
                <div class="row">
                    <div class="col-sm-6">
                        <section class="panel panel-default">
                            <header class="panel-heading font-bold">添加广告类型</header>
                            <div class="panel-body">
                                <form class="bs-example form-horizontal" id="ajaxForm" action="/excavator/index.php/Admin/AdverType/add">
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">类型名称</label>
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control" name="name" placeholder="Name">
                                            <span class="help-block m-b-none">类型名称不能小于2位.</span>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">图片宽度</label>
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control" name="width" placeholder="Width">
                                            <span class="help-block m-b-none">限制上传广告图片的宽度，必须为数字.</span>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">图片高度</label>
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control" name="width" placeholder="Height">
                                            <span class="help-block m-b-none">限制上传广告图片的高度，必须为数字.</span>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">类型描述</label>
                                        <div class="col-sm-10">
                                            <textarea class="form-control" name="summary" rows="5" data-minwords="6" data-required="true" placeholder="Type the summary"></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-offset-2 col-lg-10">
                                            <button type="submit" class="btn btn-sm btn-default">添加广告类型</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
    ...
    <script src="/excavator/Public/Admin/js/type/index.js"></script>
