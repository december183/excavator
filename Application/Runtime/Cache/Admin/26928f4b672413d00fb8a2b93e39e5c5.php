    ...
    <section id="content">
        <section class="vbox">
            <section class="scrollable padder">
                ...
                <div class="m-b-md">
                    <h3 class="m-b-none">添加配件</h3>
                </div>
                <div class="row">
                    <div class="col-sm-12">
                        <section class="panel panel-default">
                            <header class="panel-heading font-bold">添加配件</header>
                            <div class="panel-body">
                                <form class="bs-example form-horizontal" id="ajaxForm" action="/excavator/index.php?s=/Admin/Accessory/add">
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">配件型号</label>
                                        <div class="col-lg-4">
                                            <input type="text" class="form-control" name="accesno" placeholder="Accesno">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-4">
                                            <select name="cateid" id="cateid" class="form-control m-b">
                                                ...
                                                <?php if(is_array($catelist)): $i = 0; $__LIST__ = $catelist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); ?></option>
                                                    <?php if(is_array($vo['child'])): $i = 0; $__LIST__ = $vo['child'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$voo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($voo["id"]); ?>"><?php echo ($voo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; endforeach; endif; else: echo "" ;endif; ?>
                                            </select>
                                        </div>
                                        <div class="col-lg-6"></div>
                                    </div>
                                        ...
                                        <div class="col-sm-10">
                                            <?php if(is_array($machinelist)): $i = 0; $__LIST__ = $machinelist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><label class="checkbox pad-top top-cate"><?php echo ($vo["name"]); ?></label>
                                                <?php if(is_array($vo['child'])): $i = 0; $__LIST__ = $vo['child'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$voo): $mod = ($i % 2 );++$i;?><label class="checkbox-inline sub-cate">
                                                        <input type="checkbox" name="ids[]" value="<?php echo ($voo["id"]); ?>"> <?php echo ($voo["machineno"]); ?> </label><?php endforeach; endif; else: echo "" ;endif; endforeach; endif; else: echo "" ;endif; ?>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-lg-offset-2 col-lg-10">
                                            <button type="submit" class="btn btn-sm btn-default">添加配件</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
