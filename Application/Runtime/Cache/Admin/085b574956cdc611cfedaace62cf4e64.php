...
<section class="vbox">
    ...
    <ul class="nav navbar-nav navbar-right hidden-xs nav-user">
        ...
        <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <span class="thumb-sm avatar pull-left"> <img src="/excavator/Public/Admin/images/avatar.jpg"> </span> John.Smith <b class="caret"></b> </a>
            <ul class="dropdown-menu animated fadeInRight">
                ...
                <li class="divider"></li>
                <li> <a href="/excavator/index.php?s=/Admin/Index/logout" data-toggle="ajaxModal" >Logout</a> </li>
            </ul>
        </li>
    </ul>
</header>
    ...
    <link rel="stylesheet" href="/excavator/Public/Admin/js/calendar/bootstrap_calendar.css" type="text/css" cache="false" />
    <!-- Bootstrap -->
    ...
    <script src="/excavator/Public/Admin/js/charts/flot/jquery.flot.min.js" cache="false"></script>
    <script src="/excavator/Public/Admin/js/charts/flot/jquery.flot.tooltip.min.js" cache="false"></script>
    <script src="/excavator/Public/Admin/js/charts/flot/jquery.flot.resize.js" cache="false"></script>
    <script src="/excavator/Public/Admin/js/charts/flot/jquery.flot.grow.js" cache="false"></script>
    <script src="/excavator/Public/Admin/js/charts/flot/demo.js" cache="false"></script>
    <script src="/excavator/Public/Admin/js/calendar/bootstrap_calendar.js" cache="false"></script>
    <script src="/excavator/Public/Admin/js/calendar/demo.js" cache="false"></script>
                ...
                <div>
                    ...
                    <section class="comment-list block">
                        ...
                        <article id="comment-id-2" class="comment-reply">
                            <article class="comment-item"> <a class="pull-left thumb-sm"> <img src="/excavator/Public/Admin/images/avatar_default.jpg" class="img-circle"> </a>
                                <section class="comment-body m-b-lg">
                            ...
                            <article class="comment-item"> <a class="pull-left thumb-sm"> <img src="/excavator/Public/Admin/images/avatar.jpg" class="img-circle"> </a>
                                <section class="comment-body m-b-lg">
