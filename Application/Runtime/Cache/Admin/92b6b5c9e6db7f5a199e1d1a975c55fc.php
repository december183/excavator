    ...
    <section class="vbox">
        <section class="scrollable padder">
            <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
                ...
                <li><a href="/excavator/index.php/Admin/Adver/add">新增广告</a></li>
            </ul>
            <div class="m-b-md">
            ...
            <section class="panel panel-default">
                ...
                <form id="ajaxForm" action="/excavator/index.php/Admin/Adver/index">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped b-t b-light text-sm" id="table-info">
                            ...
                            <?php if(is_array($adverlist)): $i = 0; $__LIST__ = $adverlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                    ...
                                    <td><a href="#" class="pull-left thumb-sm"><img src="<?php echo ($vo["pic"]); ?>" class="img-rounded"></a></td>
                                    ...
                                    <td><?php if($vo['isrec'] == 1): ?><a href="#" onclick="setStatus(<?php echo ($vo["id"]); ?>,this)">展示中</a><?php else: ?><a href="#" onclick="setStatus(<?php echo ($vo["id"]); ?>,this)">未展示</a><?php endif; ?></td>
                                    <td><a href="/excavator/index.php/Admin/Adver/edit/id/<?php echo ($vo["id"]); ?>" title="编辑"><i class="fa fa-edit text-success text"></i></a>　<a href="javascript:;" onclick="return ajaxDel(<?php echo ($vo["id"]); ?>,this);" data-toggle="class" title="删除"><i class="fa fa-times text-danger text"></i></a></td>
