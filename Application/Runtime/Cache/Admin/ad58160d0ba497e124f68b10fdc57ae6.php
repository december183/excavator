    ...
    <ul class="nav navbar-nav navbar-right hidden-xs nav-user">
        ...
        <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <span class="thumb-sm avatar pull-left"> <img src="/excavator/Public/Admin/images/avatar.jpg"> </span> John.Smith <b class="caret"></b> </a>
            <ul class="dropdown-menu animated fadeInRight">
                ...
                <li class="divider"></li>
                <li> <a href="/excavator/index.php/Admin/Order/logout" data-toggle="ajaxModal" >Logout</a> </li>
            </ul>
        </li>
    </ul>
</header>
    ...
    <section class="vbox">
        <section class="scrollable padder">
            <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
                ...
                <li><a href="/excavator/index.php/Admin/Order/index">订单列表</a></li>
            </ul>
            <div class="m-b-md">
            ...
            <section class="panel panel-default">
                ...
                <form id="ajaxForm" action="/excavator/index.php/Admin/Order/index">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped b-t b-light text-sm" id="table-info">
                            ...
                            <?php if(is_array($activelist)): $i = 0; $__LIST__ = $activelist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                    <td rowspan="<?php echo ($vo["count"]); ?>"><input type="checkbox" name="ids[]" value="<?php echo ($vo["id"]); ?>"></td>
                                    <?php if(is_array($$vo['info'])): $i = 0; $__LIST__ = $$vo['info'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$voo): $mod = ($i % 2 );++$i; if($key == 0): ?><td><a href="#" class="pull-left thumb-sm"><img src="<?php echo ($voo["thumbpic"]); ?>" class="img-rounded"></a></td>
                                    <td><?php echo ($voo["title"]); ?></td>
                                    <td><?php echo ($voo["num"]); ?></td>
                                    <td><?php echo ($voo["price"]); ?></td>
                                    <td rowspan="<?php echo ($vo["count"]); ?>"><?php echo ($vo["order_no"]); ?></td>
                                    ...
                                    <td rowspan="<?php echo ($vo["count"]); ?>"><a href="/excavator/index.php/Admin/Order/detail/id/<?php echo ($vo["id"]); ?>" data-toggle="class" title="查看详情"><i class="fa fa-eyes text-primary text"></i></a>　<a href="javascript:;" onclick="return ajaxDel(<?php echo ($vo["id"]); ?>,this);" data-toggle="class" title="删除"><i class="fa fa-times text-danger text"></i></a></td>
                                </tr>
                                    <?php else: ?>
                                <tr>
        ...
        <script src="/excavator/Public/Admin/js/order/index.js"></script>
