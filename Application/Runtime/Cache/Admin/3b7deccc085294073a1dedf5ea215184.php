    ...
    <section id="content">
        <section class="vbox">
            <section class="scrollable padder">
                ...
                <div class="m-b-md">
                    <h3 class="m-b-none">微信配置</h3>
                </div>
                <div class="row">
                    <div class="col-sm-12">
                        <section class="panel panel-default">
                            <header class="panel-heading font-bold">微信配置</header>
                            <div class="panel-body">
                                <form class="bs-example form-horizontal" id="ajaxForm" action="/excavator/index.php?s=/Admin/Config/wechat">
                                    <?php if(is_array($configlist)): $i = 0; $__LIST__ = $configlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; switch($vo['fieldtype']): case "0": ?><div class="form-group">
                                            ...
                                            <!--字符串-->
                                            <?php case "1": ?><div class="form-group">
                                                    <label class="col-lg-2 control-label"><?php echo ($vo["title"]); ?></label>
                                                    <div class="col-lg-6">
