    ...
    <section class="vbox">
        <section class="scrollable padder">
            <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
                ...
                <li><a href="/excavator/index.php/Admin/Activity/add">新增活动</a></li>
            </ul>
            <div class="m-b-md">
                <h3 class="m-b-none">活动列表</h3>
            </div>
            <section class="panel panel-default">
                <header class="panel-heading"> 活动列表 </header>
                <form id="ajaxForm" action="/excavator/index.php/Admin/Activity/index">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped b-t b-light text-sm" id="table-info">
                            ...
                            <tr>
                                ...
                                <th class="th-sortable" data-toggle="class"> 主题图片 <span class="th-sort"> <i class="fa fa-sort-down text"></i> <i class="fa fa-sort-up text-active"></i> <i class="fa fa-sort"></i> </span> </th>
                                <th>活动主题</th>
                                <th>活动描述</th>
                                <th>开始时间</th>
                                <th>结束时间</th>
                            ...
                            <tbody>
                            <?php if(is_array($activelist)): $i = 0; $__LIST__ = $activelist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                    ...
                                    <td><a href="/excavator/index.php/Admin/Activity/edit/id/<?php echo ($vo["id"]); ?>" title="编辑"><i class="fa fa-edit text-success text"></i></a>　<a href="javascript:;" onclick="return ajaxDel(<?php echo ($vo["id"]); ?>,this);" data-toggle="class" title="删除"><i class="fa fa-times text-danger text"></i></a></td>
