        ...
        <section class="vbox">
            <section class="scrollable padder">
                <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
                    ...
                    <li><a href="/excavator/index.php/Admin/Manage/index">管理员列表</a></li>
                    <li><a href="/excavator/index.php/Admin/Manage/add">添加管理员</a></li>
                </ul>
                <div class="m-b-md">
                    <h3 class="m-b-none">添加管理员</h3>
                </div>
                <div class="row">
                    <div class="col-sm-6">
                        <section class="panel panel-default">
                            <header class="panel-heading font-bold">添加管理员</header>
                            <div class="panel-body">
                                <form class="bs-example form-horizontal" id="ajaxForm" action="/excavator/index.php/Admin/Manage/add">
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">管理员名称</label>
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control" name="username" placeholder="Username">
                                            <span class="help-block m-b-none">用户名称不能小于2位.</span>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">管理员组</label>
                                        <div class="col-lg-10">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea class="form-control" name="remark" rows="6" data-minwords="6" data-required="true" placeholder="Type your sign"></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-lg-offset-2 col-lg-10">
                                            <button type="submit" class="btn btn-sm btn-default">新增管理员</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
