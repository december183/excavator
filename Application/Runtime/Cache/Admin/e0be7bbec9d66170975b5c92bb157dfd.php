    ...
    <section class="vbox">
        <section class="scrollable padder">
            ...
            <section class="panel panel-default">
                ...
                <form id="ajaxForm" action="/excavator/index.php?s=/Admin/CreditGoods/index">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped b-t b-light text-sm" id="table-info">
                            ...
                            <?php if(is_array($goodslist)): $i = 0; $__LIST__ = $goodslist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                    ...
                                    <td><a href="#" class="pull-left thumb-sm"><img src="<?php echo (substr($vo["thumbpic"],0,65)); ?>" class="img-rounded"></a></td>
                                    ...
                                    <td><?php if($vo['isfreight'] == 1): ?>是<?php else: ?>否<?php endif; ?></td>
                                    ...
                                    <td><a href="/excavator/index.php?s=/Admin/CreditGoods/edit/id/<?php echo ($vo["id"]); ?>" title="编辑"><i class="fa fa-edit text-success text"></i></a>　<a onclick="return ajaxDel(<?php echo ($vo["id"]); ?>,this);" data-toggle="class" title="删除"><i class="fa fa-times text-danger text"></i></a></td>
