...
<section class="vbox">
    ...
    <section class="vbox">
        <section class="scrollable padder">
            ...
            <div class="m-b-md">
                <h3 class="m-b-none">属性列表</h3>
            </div>
            <section class="panel panel-default">
                <header class="panel-heading"> 属性列表 </header>
                <form id="ajaxForm" action="/excavator/index.php/Admin/Attr/index">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped b-t b-light text-sm" id="table-info">
                            ...
                            <tr>
                                ...
                                <th class="th-sortable" data-toggle="class"> <span class="th-sort"> <i class="fa fa-sort-down text"></i> <i class="fa fa-sort-up text-active"></i> <i class="fa fa-sort"></i> </span> 属性名称</th>
                                <th>关联分类</th>
                                <th>属性类型</th>
                                <th>属性值</th>
                                <th>操作</th>
                            ...
                            <?php if(is_array($attrlist)): $i = 0; $__LIST__ = $attrlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                    ...
                                    <td><a href="/excavator/index.php/Admin/Attr/edit/id/<?php echo ($vo["id"]); ?>" title="编辑"><i class="fa fa-edit text-success text"></i></a>　<a href="javascript:;" onclick="return ajaxDel(<?php echo ($vo["id"]); ?>,this);" data-toggle="class" title="删除"><i class="fa fa-times text-danger text"></i></a></td>
