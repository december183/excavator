    ...
    <ul class="nav navbar-nav navbar-right hidden-xs nav-user">
        ...
        <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <span class="thumb-sm avatar pull-left"> <img src="/excavator/Public/Admin/images/avatar.jpg"> </span> John.Smith <b class="caret"></b> </a>
            <ul class="dropdown-menu animated fadeInRight">
                ...
                <li class="divider"></li>
                <li> <a href="/excavator/index.php?s=/Admin/Withdraw/logout" data-toggle="ajaxModal" >Logout</a> </li>
            </ul>
        </li>
    </ul>
</header>
    ...
    <section class="vbox">
        <section class="scrollable padder">
            <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
                ...
                <li><a href="/excavator/index.php?s=/Admin/Withdraw/index">提现列表</a></li>
            </ul>
            <div class="m-b-md">
            ...
            <section class="panel panel-default">
                ...
                <form id="ajaxForm" action="/excavator/index.php?s=/Admin/Withdraw/index">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped b-t b-light text-sm" id="table-info">
                            ...
                            <tbody>
                            <?php if(is_array($withdrawlist)): $i = 0; $__LIST__ = $withdrawlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                    <td><input type="checkbox" name="ids[]" value="<?php echo ($vo["id"]); ?>"></td>
                                    <td><?php echo ($vo["realname"]); ?></td>
                                    <td><?php echo ($vo["phone"]); ?></td>
                                    <td><?php echo ($vo["money"]); ?></td>
                                    <td><?php if($vo['type'] == 1): ?>微信<?php elseif($vo['type'] == 2): ?>支付宝<?php else: endif; ?></td>
                                    <td><?php echo ($vo["account"]); ?></td>
                                    <td><?php echo (date('Y-m-d',$vo["datetime"])); ?></td>
                                    <td><?php if($vo['status'] == 1): ?><a href="#" onclick="setStatus(<?php echo ($vo["id"]); ?>,this)"><span class="text-primary text">已处理</span></a><?php else: ?><a href="#" onclick="setStatus(<?php echo ($vo["id"]); ?>,this)"><span class="text-danger text">待处理</span></a><?php endif; ?></td>
        ...
        <script src="/excavator/Public/Admin/js/withdraw/index.js"></script>
