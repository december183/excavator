    ...
    <ul class="nav navbar-nav navbar-right hidden-xs nav-user">
        ...
        <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <span class="thumb-sm avatar pull-left"> <img src="/excavator/Public/Admin/images/avatar.jpg"> </span> John.Smith <b class="caret"></b> </a>
            <ul class="dropdown-menu animated fadeInRight">
                ...
                <li class="divider"></li>
                <li> <a href="/excavator/index.php?s=/Admin/Manage/logout" data-toggle="ajaxModal" >Logout</a> </li>
            </ul>
        </li>
    </ul>
</header>
        ...
        <section class="vbox">
            <section class="scrollable padder">
                <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
                    ...
                    <li><a href="/excavator/index.php?s=/Admin/Manage/reset">修改密码</a></li>
                </ul>
                <div class="m-b-md">
                    ...
                    <div class="col-sm-6">
                        <section class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <form class="bs-example form-horizontal" id="ajaxForm" action="/excavator/index.php?s=/Admin/Manage/edit">
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">管理员名称</label>
                                        <div class="col-lg-10">
                                            <!--<input type="text" class="form-control" name="username" placeholder="Username" value="<?php echo ($oneManage["username"]); ?>">-->
                                            <span class="help-block m-b-none"><?php echo ($oneManage["username"]); ?></span>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            ...
                                            <span class="help-block m-b-none">密码为空时默认不修改</span>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">确认密码</label>
                                        <div class="col-lg-10">
                                            <input type="password" class="form-control" name="chkpass" placeholder="Password">
                                            <span class="help-block m-b-none">必须与所填密码一致.</span>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">手机号码</label>
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control" name="phone" placeholder="Phone" value="<?php echo ($oneManage["phone"]); ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">管理员邮箱</label>
                                        <div class="col-lg-10">
                                            <input type="email" class="form-control" name="email" placeholder="Email" value="<?php echo ($oneManage["email"]); ?>">
                                            <span class="help-block m-b-none">请正确填写.</span> </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <a href="#" class="thumb-sm"><img src="<?php echo ($oneManage["avatar"]); ?>" class="img-rounded"></a>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">备注签名</label>
                                        <div class="col-sm-10">
                                            <textarea class="form-control" name="remark" rows="6" data-minwords="6" data-required="true" placeholder="Type your sign"><?php echo ($oneManage["remark"]); ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-lg-offset-2 col-lg-10">
                                            <button type="submit" class="btn btn-sm btn-default">提 交</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
