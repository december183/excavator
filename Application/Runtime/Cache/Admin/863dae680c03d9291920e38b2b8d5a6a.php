        ...
        <section class="vbox">
            <section class="scrollable padder">
                <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
                    ...
                    <li><a href="/excavator/index.php?s=/Admin/Group/edit/id/<?php echo ($oneGroup["id"]); ?>">修改管理组</a></li>
                </ul>
                <div class="m-b-md">
                    <h3 class="m-b-none">修改管理组</h3>
                </div>
                <div class="row">
                    <div class="col-sm-12">
                        <section class="panel panel-default">
                            <header class="panel-heading font-bold">修改管理组</header>
                            <div class="panel-body">
                                <form class="bs-example form-horizontal" id="ajaxForm" action="/excavator/index.php?s=/Admin/Group/edit">
                                    <input type="hidden" name="id" value="<?php echo ($oneGroup["id"]); ?>" />
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">管理组名称</label>
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control" name="name" placeholder="name" value="<?php echo ($oneGroup["name"]); ?>">
                                            <span class="help-block m-b-none">管理组名称不能小于2位.</span>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">管理组权限</label>
                                        <div class="col-sm-10">
                                            <?php if(is_array($authlist)): $i = 0; $__LIST__ = $authlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><label class="block pad-top"><?php echo ($vo["name"]); ?></label>
                                                <?php if(is_array($vo['child'])): $i = 0; $__LIST__ = $vo['child'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$voo): $mod = ($i % 2 );++$i;?><label class="checkbox-inline">
                                                        <input type="checkbox" name="ids[]" value="<?php echo ($voo["id"]); ?>" <?php if(in_array(($voo['id']), is_array($oneGroup['auth'])?$oneGroup['auth']:explode(',',$oneGroup['auth']))): ?>checked="checked"<?php endif; ?>> <?php echo ($voo["name"]); ?> </label><?php endforeach; endif; else: echo "" ;endif; endforeach; endif; else: echo "" ;endif; ?>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="radio-inline pad-lf-none">
                                                        <label class="radio-custom margin-lf-none">
                                                            <input type="radio" name="status" value="1" <?php if($oneGroup['status'] == 1): ?>checked="checked"<?php endif; ?>>
                                                            <i class="fa fa-circle-o"></i> 是 </label>
                                                    </div>
                                                    <div class="radio-inline pad-lf-none">
                                                        <label class="radio-custom margin-lf-none">
                                                            <input type="radio" name="status" value="0" <?php if($oneGroup['status'] == 0): ?>checked="checked"<?php endif; ?>>
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-offset-2 col-lg-10">
                                            <button type="submit" class="btn btn-sm btn-default">修改管理组</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
