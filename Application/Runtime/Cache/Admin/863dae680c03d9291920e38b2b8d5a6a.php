        ...
        <section class="vbox">
            <section class="scrollable padder">
                <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
                    ...
                    <li><a href="/excavator/index.php/Admin/Group/edit/id/<?php echo ($oneGroup["id"]); ?>">修改管理组</a></li>
                </ul>
                <div class="m-b-md">
                    ...
                    <div class="col-sm-12">
                        <section class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <form class="bs-example form-horizontal" id="ajaxForm" action="/excavator/index.php/Admin/Group/edit">
