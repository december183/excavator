...
<section class="vbox">
    ...
    <section class="vbox">
        <section class="scrollable padder">
            ...
            <div class="m-b-md">
                <h3 class="m-b-none">管理员列表</h3>
            </div>
            <section class="panel panel-default">
                <header class="panel-heading"> 管理员列表 </header>
                <form id="ajaxForm" action="/excavator/index.php/Admin/Manage/index">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped b-t b-light text-sm" id="table-info">
                            ...
                            <tr>
                                ...
                                <th class="th-sortable" data-toggle="class">用户头像 <span class="th-sort"> <i class="fa fa-sort-down text"></i> <i class="fa fa-sort-up text-active"></i> <i class="fa fa-sort"></i> </span> </th>
                                <th>用户名</th>
                                <th>邮箱</th>
                                <th>手机号</th>
                                <th>备注</th>
                            ...
                            <?php if(is_array($managelist)): $i = 0; $__LIST__ = $managelist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                    ...
                                    <td><a href="#" class="pull-left thumb-sm"><img src="<?php echo ($vo["avatar"]); ?>" class="img-rounded"></a></td>
                                    ...
                                    <td><a href="/excavator/index.php/Admin/Manage/edit/id/<?php echo ($vo["id"]); ?>" title="编辑"><i class="fa fa-edit text-success text"></i></a>　<a href="javascript:;" onclick="return ajaxDel(<?php echo ($vo["id"]); ?>,this);" data-toggle="class" title="删除"><i class="fa fa-times text-danger text"></i></a></td>
