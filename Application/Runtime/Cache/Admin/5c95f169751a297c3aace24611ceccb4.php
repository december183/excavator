...
<section class="vbox">
    ...
    <ul class="nav navbar-nav navbar-right hidden-xs nav-user">
        ...
        <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <span class="thumb-sm avatar pull-left"> <img src="/excavator/Public/Admin/images/avatar.jpg"> </span> John.Smith <b class="caret"></b> </a>
            <ul class="dropdown-menu animated fadeInRight">
                ...
                <li class="divider"></li>
                <li> <a href="/excavator/index.php?s=/Admin/Page/logout" data-toggle="ajaxModal" >Logout</a> </li>
            </ul>
        </li>
    </ul>
</header>
  ...
  <script src="/excavator/Public/Admin/js/libs/backbone-min.js" cache="false"></script>
  <script src="/excavator/Public/Admin/js/libs/backbone.localStorage-min.js" cache="false"></script>
  <script src="/excavator/Public/Admin/js/libs/moment.min.js" cache="false"></script>
  <!-- Notes -->
  <script src="/excavator/Public/Admin/js/apps/notes.js" cache="false"></script>
  <section id="content">
