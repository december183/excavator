...
<section class="vbox">
    ...
    <section class="vbox">
        <section class="scrollable padder">
            ...
            <div class="m-b-md">
                <h3 class="m-b-none">配件列表</h3>
            </div>
            <section class="panel panel-default">
                <header class="panel-heading"> 配件列表 </header>
                <form id="ajaxForm" action="/excavator/index.php?s=/Admin/Accessory/index">
                    <div class="row text-sm wrapper">
                        ...
                        <div class="col-sm-3 m-b-xs">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <select name="brand" id="brandid" class="input-sm form-control input-s-sm inline">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped b-t b-light text-sm" id="table-info">
                            ...
                            <tr>
                                ...
                                <th class="th-sortable" data-toggle="class"> 配件图片 <span class="th-sort"> <i class="fa fa-sort-down text"></i> <i class="fa fa-sort-up text-active"></i> <i class="fa fa-sort"></i> </span> </th>
                                <th>配件型号</th>
                                <th>配件分类</th>
                                <th>配件品牌</th>
                                <th>关联机型</th>
                            ...
                            <tbody>
                            <?php if(is_array($accessorylist)): $i = 0; $__LIST__ = $accessorylist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                    <td><input type="checkbox" name="ids[]" value="<?php echo ($vo["id"]); ?>"></td>
                                    <td><a href="#" class="pull-left thumb-sm"><img src="<?php echo ($vo["thumbpic"]); ?>" class="img-rounded"></a></td>
                                    <td><?php echo ($vo["accesno"]); ?></td>
                                    <td><?php echo ($vo["catename"]); ?></td>
                                    <td><?php echo ($vo["brandname"]); ?></td>
                                    <td><?php echo ($vo["machineno"]); ?></td>
                                    <td><a href="/excavator/index.php?s=/Admin/Accessory/edit/id/<?php echo ($vo["id"]); ?>" title="编辑"><i class="fa fa-edit text-success text"></i></a>　<a onclick="return ajaxDel(<?php echo ($vo["id"]); ?>,this);" data-toggle="class" title="删除"><i class="fa fa-times text-danger text"></i></a></td>
