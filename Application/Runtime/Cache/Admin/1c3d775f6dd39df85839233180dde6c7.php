    ...
    <section id="content">
        <section class="vbox">
            <section class="scrollable padder">
                ...
                <div class="m-b-md">
                    <h3 class="m-b-none">添加积分商品</h3>
                </div>
                <div class="row">
                    <div class="col-sm-12">
                        <section class="panel panel-default">
                            <header class="panel-heading font-bold">添加积分商品</header>
                            <div class="panel-body">
                                <form class="bs-example form-horizontal" id="ajaxForm" action="/excavator/index.php?s=/Admin/CreditGoods/add">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <input type="text" class="form-control" name="thumbpic" id="thumbpic" />
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-10" id="thumb"></div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">商品描述</label>
                                        <div class="col-sm-10">
                                            <textarea class="form-control" name="descript" rows="5" data-minwords="6" data-required="true" placeholder="Type the descript"></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="radio-inline pad-lf-none">
                                                        <label class="radio-custom margin-lf-none">
                                                            <input type="radio" name="isfreight" value="1" checked="checked">
                                                            <i class="fa fa-circle-o"></i> 是 </label>
                                                    </div>
                                                    <div class="radio-inline pad-lf-none">
                                                        <label class="radio-custom margin-lf-none">
                                                            <input type="radio" name="isfreight" value="0">
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-offset-2 col-lg-10">
                                            <button type="submit" class="btn btn-sm btn-default">添加积分商品</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
