...
<section class="vbox">
    ...
    <section class="vbox">
        <section class="scrollable padder">
            ...
            <div class="m-b-md">
                <h3 class="m-b-none">文章类型列表</h3>
            </div>
            <section class="panel panel-default">
                <header class="panel-heading"> 文章类型列表 </header>
                <form id="ajaxForm" action="/excavator/index.php/Admin/ArticleType/index">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped b-t b-light text-sm" id="table-info">
                            ...
                            <?php if(is_array($typelist)): $i = 0; $__LIST__ = $typelist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                    ...
                                    <td><a href="/excavator/index.php/Admin/ArticleType/edit/id/<?php echo ($vo["id"]); ?>" title="编辑"><i class="fa fa-edit text-success text"></i></a>　<a href="javascript:;" onclick="return ajaxDel(<?php echo ($vo["id"]); ?>,this);" data-toggle="class" title="删除"><i class="fa fa-times text-danger text"></i></a></td>
