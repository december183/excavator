...
<section class="vbox">
    ...
    <ul class="nav navbar-nav navbar-right hidden-xs nav-user">
        ...
        <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <span class="thumb-sm avatar pull-left"> <img src="/excavator/Public/Admin/images/avatar.jpg"> </span> John.Smith <b class="caret"></b> </a>
            <ul class="dropdown-menu animated fadeInRight">
                ...
                <li class="divider"></li>
                <li> <a href="/excavator/index.php/Admin/Adver/logout" data-toggle="ajaxModal" >Logout</a> </li>
            </ul>
        </li>
    </ul>
</header>
        ...
        <section class="vbox">
            <section class="scrollable padder">
                <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
                    ...
                    <li><a href="/excavator/index.php/Admin/Adver/index">广告列表</a></li>
                    <li><a href="/excavator/index.php/Admin/Adver/add">添加广告</a></li>
                </ul>
                <div class="m-b-md">
                    <h3 class="m-b-none">添加广告</h3>
                </div>
                <div class="row">
                    <div class="col-sm-6">
                        <section class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <form class="bs-example form-horizontal" id="ajaxForm" action="/excavator/index.php/Admin/Adver/add">
                                    <input type="hidden" name="width" class="adverWidth" value="" />
                                    <input type="hidden" name="height" class="adverHeight" value="" />
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">广告标题</label>
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control" name="title" placeholder="Title">
                                            <span class="help-block m-b-none">广告标题不能小于2位.</span>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            ...
                                            <span class="help-block m-b-none">必须以http://开头.</span>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">广告类型</label>
                                        <div class="col-lg-10">
                                            <select name="type" id="adverType" class="form-control m-b">
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-offset-2 col-lg-10">
                                            <button type="submit" class="btn btn-sm btn-default">添加广告</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
    ...
    <script src="/excavator/Public/Admin/js/adver/index.js"></script>
