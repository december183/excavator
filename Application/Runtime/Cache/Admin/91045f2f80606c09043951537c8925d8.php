    ...
    <ul class="nav navbar-nav navbar-right hidden-xs nav-user">
        ...
        <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <span class="thumb-sm avatar pull-left"> <img src="/excavator/Public/Admin/images/avatar.jpg"> </span> John.Smith <b class="caret"></b> </a>
            <ul class="dropdown-menu animated fadeInRight">
                ...
                <li class="divider"></li>
                <li> <a href="/excavator/index.php?s=/Admin/Article/logout" data-toggle="ajaxModal" >Logout</a> </li>
            </ul>
        </li>
    </ul>
</header>
        ...
        <section class="vbox">
            <section class="scrollable padder">
                <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
                    ...
                    <li><a href="/excavator/index.php?s=/Admin/Article/index">文章列表</a></li>
                    <li><a href="/excavator/index.php?s=/Admin/Article/add">添加文章</a></li>
                </ul>
                <div class="m-b-md">
                    <h3 class="m-b-none">添加文章</h3>
                </div>
                <div class="row">
                    <div class="col-sm-12">
                        <section class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <form class="bs-example form-horizontal" id="ajaxForm" action="/excavator/index.php?s=/Admin/Article/add">
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">文章标题</label>
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" name="title" placeholder="Title">
                                            <span class="help-block m-b-none">文章标题不能小于2位.</span>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <span class="help-block m-b-none">多个标签用逗号隔开.</span>
                                        </div>
                                        <div class="col-lg-4"></div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">文章作者</label>
                                        <div class="col-lg-4">
                                    ...
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">文章来源</label>
                                        <div class="col-lg-4">
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-offset-2 col-lg-10">
                                            <button type="submit" class="btn btn-sm btn-default">添加文章</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
