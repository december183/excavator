  ...
  <section id="content">
    <div class="bg-dark lt">
      <div class="container">
        <div class="m-b-lg m-t-lg">
          ...
          <small class="text-muted">Choose the plan that best fits your needs</small> </div>
      </div>
    </div>
        ...
        <div class="row m-b-xl">
          <div class="col-sm-4 animated fadeInLeftBig">
            <section class="panel b-light text-center m-t">
              ...
              <ul class="list-group">
                <li class="list-group-item text-center bg-light lt"> <span class="text-danger font-bold h1">$20</span> / month </li>
              ...
              <footer class="panel-footer"> <a href="#" class="btn btn-primary m-t m-b">Get Started</a> </footer>
            </section>
          </div>
          ...
          <div class="col-sm-4 animated fadeInRightBig">
            <section class="panel b-light text-center m-t">
              ...
              <ul class="list-group">
                <li class="list-group-item text-center bg-light lt"> <span class="text-danger font-bold h1">$100</span> / month </li>
    ...
    <div class="bg-white-only">
      <div class="container">
        ...
        <div class="row m-b-xl">
          <div class="col-sm-4" data-ride="animated" data-animation="fadeInLeft" data-delay="300"> <span class="fa-stack fa-2x pull-left m-r m-t-xs"> <i class="fa fa-circle fa-stack-2x text-info"></i> <i class="fa fa-stack-1x fa-inverse">1</i> </span>
            <div class="clear">
              <h4>Lightweight with Rich Components</h4>
              <p class="text-muted text-sm">We only choose the lightweight plugins, but with rich functions. we use tiny components, css and js size is first consideration. <br>
                <br>
                This project ues HTML5 and CSS3 to build the components and widgets. the pages use header, nav, section to build the layout.</p>
            </div>
          </div>
          <div class="col-sm-4" data-ride="animated" data-animation="fadeInLeft" data-delay="600"> <span class="fa-stack fa-2x pull-left m-r m-t-xs"> <i class="fa fa-circle fa-stack-2x text-info"></i> <i class="fa fa-stack-1x fa-inverse">2</i> </span>
            <div class="clear">
              <h4>Keep Updating with Great Support</h4>
              <p class="text-muted text-sm">This project is based on Bootstrap 3. the sleek, intuitive, and powerful mobile-first front-end framework for faster and easier web development. we will keep it updated to Bootstrap.<br>
                <br>
                <a href="#" class="text-primary">More...</a></p>
            </div>
          </div>
          <div class="col-sm-4" data-ride="animated" data-animation="fadeInLeft" data-delay="900"> <span class="fa-stack fa-2x pull-left m-r m-t-xs"> <i class="fa fa-circle fa-stack-2x text-info"></i> <i class="fa fa-stack-1x fa-inverse">3</i> </span>
            <div class="clear">
