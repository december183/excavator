        ...
        <section class="vbox">
            <section class="scrollable padder">
                <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
                    ...
                    <li><a href="/excavator/index.php?s=/Admin/Brand/edit/id/<?php echo ($oneBrand["id"]); ?>">修改品牌</a></li>
                </ul>
                <div class="m-b-md">
                    <h3 class="m-b-none">修改品牌</h3>
                </div>
                <div class="row">
                    <div class="col-sm-6">
                        <section class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <form class="bs-example form-horizontal" id="ajaxForm" action="/excavator/index.php?s=/Admin/Brand/edit">
                                    <input type="hidden" name="id" value="<?php echo ($oneBrand["id"]); ?>" />
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">品牌名称</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="name" placeholder="Name" value="<?php echo ($oneBrand["name"]); ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <a href="#" class="thumb-sm"><img src="<?php echo ($oneBrand["thumb"]); ?>" class="img-rounded"></a>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">品牌简介</label>
                                        <div class="col-sm-10">
                                            <textarea class="form-control" name="descript" rows="6" data-minwords="6" data-required="true" placeholder="Type your sign"><?php echo ($oneBrand["descript"]); ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-lg-offset-2 col-lg-10">
                                            <button type="submit" class="btn btn-sm btn-default">修改品牌</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
