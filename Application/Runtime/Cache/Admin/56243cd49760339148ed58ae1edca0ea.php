...
<section class="vbox">
    ...
    <ul class="nav navbar-nav navbar-right hidden-xs nav-user">
        ...
        <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <span class="thumb-sm avatar pull-left"> <img src="/excavator/Public/Admin/images/avatar.jpg"> </span> John.Smith <b class="caret"></b> </a>
            <ul class="dropdown-menu animated fadeInRight">
                ...
                <li class="divider"></li>
                <li> <a href="/excavator/index.php?s=/Admin/CreditGoods/logout" data-toggle="ajaxModal" >Logout</a> </li>
            </ul>
        </li>
    </ul>
</header>
    ...
    <!--kindeditor-->
    <script charset="utf-8" src="/excavator/Plugins/kindeditor/kindeditor-min.js"></script>
    <script charset="utf-8" src="/excavator/Plugins/kindeditor/lang/zh_CN.js"></script>
    <!-- jQuery -->
        ...
        <section class="vbox">
            <section class="scrollable padder">
                <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
                    ...
                    <li><a href="/excavator/index.php?s=/Admin/CreditGoods/index">积分商品列表</a></li>
                    <li><a href="/excavator/index.php?s=/Admin/CreditGoods/add">添加积分商品</a></li>
                    <li><a href="/excavator/index.php?s=/Admin/CreditGoods/edit/id/<?php echo ($oneGoods["id"]); ?>">修改积分商品</a></li>
                </ul>
                <div class="m-b-md">
                    <h3 class="m-b-none">修改积分商品</h3>
                </div>
                <div class="row">
                    <div class="col-sm-12">
                        <section class="panel panel-default">
                            <header class="panel-heading font-bold">修改积分商品</header>
                            <div class="panel-body">
                                <form class="bs-example form-horizontal" id="ajaxForm" action="/excavator/index.php?s=/Admin/CreditGoods/edit">
                                    <input type="hidden" name="id" value="<?php echo ($oneGoods["id"]); ?>" />
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">商品名称</label>
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" name="title" placeholder="Title" value="<?php echo ($oneGoods["title"]); ?>">
                                            <span class="help-block m-b-none">商品名称不能小于2位.</span>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" name="tags" placeholder="Tags" value="<?php echo ($oneGoods["tags"]); ?>">
                                            <span class="help-block m-b-none">多个标签以逗号隔开.</span>
                                        </div>
                                        <div class="col-lg-4"></div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-4">
                                            <select name="cateid" id="cateid" class="form-control m-b">
                                                ...
                                                <?php if(is_array($catelist)): $i = 0; $__LIST__ = $catelist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><optgroup label="<?php echo ($vo["name"]); ?>"><?php echo ($vo["name"]); ?></optgroup>
                                                    <?php if(is_array($vo['child'])): $i = 0; $__LIST__ = $vo['child'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$voo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($voo["id"]); ?>" <?php if($oneGoods['cateid'] == $voo['id']): ?>selected="selected"<?php endif; ?>><?php echo ($voo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; endforeach; endif; else: echo "" ;endif; ?>
                                            </select>
                                        </div>
                                        <div class="col-lg-6"></div>
                                    </div>
                                    <div id="brand"><input type="hidden" name="brand" value="<?php echo ($oneGoods["brand"]); ?>" /></div>
                                    <div id="attr"><input type="hidden" name="attrstr" value='<?php echo ($oneGoods["attrstr"]); ?>' /></div>
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">所需积分</label>
                                        <div class="col-lg-4">
                                            <input type="text" class="form-control" name="credit" placeholder="Credit" value="<?php echo ($oneGoods["credit"]); ?>">
                                        </div>
                                        <div class="col-lg-6"></div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-4">
                                            <input type="text" class="form-control" name="inventory" placeholder="Inventory" value="<?php echo ($oneGoods["inventory"]); ?>">
                                        </div>
                                        <div class="col-lg-6"></div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea class="form-control" name="descript" rows="5" data-minwords="6" data-required="true" placeholder="Type the descript"><?php echo ($oneGoods["descript"]); ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">商品详情</label>
                                        <div class="col-sm-10">
                                            <textarea class="form-control" name="content" id="editor"><?php echo ($oneGoods["content"]); ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="radio-inline pad-lf-none">
                                                        <label class="radio-custom margin-lf-none">
                                                            <input type="radio" name="isfreight" value="1" <?php if($oneGoods['isfreight'] == 1): ?>checked="checked"<?php endif; ?>>
                                                            <i class="fa fa-circle-o"></i> 是 </label>
                                                    </div>
                                                    <div class="radio-inline pad-lf-none">
                                                        <label class="radio-custom margin-lf-none">
                                                            <input type="radio" name="isfreight" value="0" <?php if($oneGoods['isfreight'] == 0): ?>checked="checked"<?php endif; ?>>
                                        ...
                                        <div class="col-sm-10">
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="radio-inline pad-lf-none">
                                                        <label class="radio-custom margin-lf-none">
                                                            <input type="radio" name="isrec" value="1" <?php if($oneGoods['isrec'] == 1): ?>checked="checked"<?php endif; ?>>
                                                            <i class="fa fa-circle-o"></i> 是 </label>
                                                    </div>
                                                    <div class="radio-inline pad-lf-none">
                                                        <label class="radio-custom margin-lf-none">
                                                            <input type="radio" name="isrec" value="0" <?php if($oneGoods['isrec'] == 0): ?>checked="checked"<?php endif; ?>>
                                                            <i class="fa fa-circle-o"></i> 否 </label>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-offset-2 col-lg-10">
                                            <button type="submit" class="btn btn-sm btn-default">修改积分商品</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
    ...
    <script type="text/javascript">
        KindEditor.ready(function(K){
            var opts={
                uploadJson : '/excavator/Plugins/kindeditor/php/upload_json.php',
                fileManagerJson : '/excavator/Plugins/kindeditor/php/file_manager_json.php',
    ...
    <!-- Bootstrap -->
    <script src="/excavator/Public/Admin/js/file-input/bootstrap-filestyle.min.js" cache="false"></script>
    <script src="/excavator/Public/Admin/js/creditgoods/index.js"></script>
    <script src="/excavator/Public/Admin/js/creditgoods/info.js"></script>
    <script type="text/javascript">
        $(function(){
            var cateid=$('#cateid').val();
            var brand=$('#brand >input').val();
            var attrstr=$('#attr >input').val();
            getCurBrand(cateid,brand);
            getCurAttr(cateid,attrstr);
        });
    </script>
