    ...
    <ul class="nav navbar-nav navbar-right hidden-xs nav-user">
        ...
        <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <span class="thumb-sm avatar pull-left"> <img src="/excavator/Public/Admin/images/avatar.jpg"> </span> John.Smith <b class="caret"></b> </a>
            <ul class="dropdown-menu animated fadeInRight">
                ...
                <li class="divider"></li>
                <li> <a href="/excavator/index.php?s=/Admin/Area/logout" data-toggle="ajaxModal" >Logout</a> </li>
            </ul>
        </li>
    </ul>
</header>
    ...
    <section class="vbox">
        <section class="scrollable padder">
            <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
                ...
                <li><a href="/excavator/index.php?s=/Admin/Area/index">地区列表</a></li>
            </ul>
            <div class="m-b-md">
                <h3 class="m-b-none">地区列表</h3>
            </div>
            <section class="panel panel-default">
                <header class="panel-heading"> 地区列表 </header>
                <form id="ajaxForm" action="/excavator/index.php?s=/Admin/Area/index">
                    <div class="row text-sm wrapper">
                        <div class="col-sm-5 m-b-xs">
                            <select class="input-sm form-control input-s-sm inline" name="action">
                                <option value="0">批量操作</option>
                            </select>
                            <button class="btn btn-sm btn-default" type="button">提交</button>
                        </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped b-t b-light text-sm" id="table-info">
                            ...
                            <?php if(is_array($arealist)): $i = 0; $__LIST__ = $arealist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                    <td><input type="checkbox" name="ids[]" value="<?php echo ($vo["areano"]); ?>"></td>
                                    <td><?php echo ($vo["areano"]); ?></td>
                                    <td><?php echo ($vo["areaname"]); ?></td>
                                    <td><?php echo ($vo["parentno"]); ?></td>
                                    <td><?php echo ($vo["areacode"]); ?></td>
                                    <td><?php echo ($vo["arealevel"]); ?></td>
                ...
                <footer class="panel-footer">
                    <div class="row">
                        ...
                        <div class="col-sm-5 text-center-xs" id="page">
        ...
        <script src="/excavator/Public/Admin/js/area/index.js"></script>
