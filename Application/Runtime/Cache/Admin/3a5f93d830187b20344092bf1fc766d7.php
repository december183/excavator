...
<section class="vbox">
    ...
    <section class="vbox">
        <section class="scrollable padder">
            ...
            <div class="m-b-md">
                <h3 class="m-b-none">机型列表</h3>
            </div>
            <section class="panel panel-default">
                <header class="panel-heading"> 机型列表 </header>
                <form id="ajaxForm" action="/excavator/index.php?s=/Admin/Machine/index">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped b-t b-light text-sm" id="table-info">
                            ...
                            <tr>
                                ...
                                <th class="th-sortable" data-toggle="class"> 机型图片 <span class="th-sort"> <i class="fa fa-sort-down text"></i> <i class="fa fa-sort-up text-active"></i> <i class="fa fa-sort"></i> </span> </th>
                                <th>机器型号</th>
                                <th>所属类别</th>
                                <th>所属品牌</th>
                                <th>操作</th>
                            ...
                            <tbody>
                            <?php if(is_array($machinelist)): $i = 0; $__LIST__ = $machinelist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                    ...
                                    <td><a href="/excavator/index.php?s=/Admin/Machine/edit/id/<?php echo ($vo["id"]); ?>" title="编辑"><i class="fa fa-edit text-success text"></i></a>　<a onclick="return ajaxDel(<?php echo ($vo["id"]); ?>,this);" data-toggle="class" title="删除"><i class="fa fa-times text-danger text"></i></a></td>
