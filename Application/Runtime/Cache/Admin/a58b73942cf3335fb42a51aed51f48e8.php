    ...
    <section class="vbox">
        <section class="scrollable padder">
            ...
            <section class="panel panel-default">
                ...
                <form id="ajaxForm" action="/excavator/index.php/Admin/Auth/index">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped b-t b-light text-sm" id="table-info">
                            ...
                            <tbody>
                                <?php if(is_array($authlist)): $i = 0; $__LIST__ = $authlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="topmenu">
                                        ...
                                        <td><?php if($vo['status'] == 1): ?><a href="#" onclick="setStatus(<?php echo ($vo["id"]); ?>,this)">是</a><?php else: ?><a href="#" onclick="setStatus(<?php echo ($vo["id"]); ?>,this)">否</a><?php endif; ?></td>
                                        <td><?php if($vo['status'] == 1): ?><a href="#" onclick="setAuth(<?php echo ($vo["id"]); ?>,this)">是</a><?php else: ?><a href="#" onclick="setAuth(<?php echo ($vo["id"]); ?>,this)">否</a><?php endif; ?></td>
                                        <td><a href="/excavator/index.php/Admin/Auth/edit/id/<?php echo ($vo["id"]); ?>" title="编辑"><i class="fa fa-edit text-success text"></i></a>　<a href="javascript:;" onclick="return ajaxDel(<?php echo ($vo["id"]); ?>,this);" data-toggle="class" title="删除"><i class="fa fa-times text-danger text"></i></a></td>
                                    </tr>
                                    <?php if(is_array($vo['child'])): $i = 0; $__LIST__ = $vo['child'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$voo): $mod = ($i % 2 );++$i;?><tr class="submenu">
                                            ...
                                            <td><span class="pad-lf-level1"><?php echo ($voo["name"]); ?></span></td>
                                            <td><?php echo ($voo["icon"]); ?></td>
                                            <td><?php echo ($voo["action"]); ?></td>
                                            <td><input type="text" name="sort[<?php echo ($vo["id"]); ?>]" class="form-control short" value="<?php echo ($voo["sort"]); ?>" onblur="setSort(<?php echo ($voo["id"]); ?>,this);"></td>
                                            <td><?php if($voo['status'] == 1): ?><a href="#" onclick="setStatus(<?php echo ($voo["id"]); ?>,this)">是</a><?php else: ?><a href="#" onclick="setStatus(<?php echo ($voo["id"]); ?>,this)">否</a><?php endif; ?></td>
                                            <td><?php if($voo['status'] == 1): ?><a href="#" onclick="setAuth(<?php echo ($voo["id"]); ?>,this)">是</a><?php else: ?><a href="#" onclick="setAuth(<?php echo ($voo["id"]); ?>,this)">否</a><?php endif; ?></td>
                                            <td><a href="/excavator/index.php/Admin/Auth/edit/id/<?php echo ($voo["id"]); ?>" title="编辑"><i class="fa fa-edit text-success text"></i></a>　<a href="javascript:;" onclick="return ajaxDel(<?php echo ($voo["id"]); ?>,this);" data-toggle="class" title="删除"><i class="fa fa-times text-danger text"></i></a></td>
