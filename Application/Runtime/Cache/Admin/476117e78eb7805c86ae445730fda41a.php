...
<section class="vbox">
  ...
  <link rel="stylesheet" href="/excavator/Public/Admin/js/fullcalendar/fullcalendar.css" type="text/css" cache="false" />
  <link rel="stylesheet" href="/excavator/Public/Admin/js/fullcalendar/theme.css" type="text/css" cache="false" />
  <!-- fuelux -->
  ...
  <script src="/excavator/Public/Admin/js/fullcalendar/fullcalendar.min.js" cache="false"></script>
  <script src="/excavator/Public/Admin/js/fullcalendar/demo.js" cache="false"></script>
  <section id="content">
        ...
        <section class="vbox">
          <section class="scrollable wrapper">
            <section class="panel panel-default">
              <header class="panel-heading bg-light"> Fullcalendar </header>
        ...
        <div class="padder">
          ...
          <div class="checkbox">
            <label class="checkbox-custom">
              ...
              <i class="fa fa-square-o"></i> remove after drop</label>
          </div>
        </div>
      </aside>
      <!-- /.aside --> </section>
