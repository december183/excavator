...
<section class="vbox">
    ...
    <ul class="nav navbar-nav navbar-right hidden-xs nav-user">
        ...
        <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <span class="thumb-sm avatar pull-left"> <img src="/excavator/Public/Admin/images/avatar.jpg"> </span> John.Smith <b class="caret"></b> </a>
            <ul class="dropdown-menu animated fadeInRight">
                ...
                <li class="divider"></li>
                <li> <a href="/excavator/index.php?s=/Admin/Config/logout" data-toggle="ajaxModal" >Logout</a> </li>
            </ul>
        </li>
    </ul>
</header>
        ...
        <section class="vbox">
            <section class="scrollable padder">
                <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
                    ...
                    <li><a href="/excavator/index.php?s=/Admin/Config/index">基础配置</a></li>
                    <li><a href="/excavator/index.php?s=/Admin/Config/wechat">微信配置</a></li>
                    <li><a href="/excavator/index.php?s=/Admin/Config/other">其他配置</a></li>
                </ul>
                <div class="m-b-md">
                    <h3 class="m-b-none">其他配置</h3>
                </div>
                <div class="row">
                    <div class="col-sm-12">
                        <section class="panel panel-default">
                            <header class="panel-heading font-bold">其他配置</header>
                            <div class="panel-body">
                                <form class="bs-example form-horizontal" id="ajaxForm" action="/excavator/index.php?s=/Admin/Config/other">
                                    <?php if(is_array($configlist)): $i = 0; $__LIST__ = $configlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; switch($vo['fieldtype']): case "0": ?><div class="form-group">
                                                    <label class="col-lg-2 control-label"><?php echo ($vo["title"]); ?></label>
                                                    <div class="col-lg-6">
                                                        <input type="number" class="form-control" name="<?php echo ($vo["name"]); ?>" placeholder="<?php echo ($vo["title"]); ?>" value="<?php echo ($vo["value"]); ?>">
                                                    </div>
                                                    <div class="col-lg-4"></div>
                                                </div><?php break;?>
                                            <!--字符串-->
                                            <?php case "1": if($vo['name'] == 'WEB_PICMARK_PATH'): ?><div class="form-group">
                                                        <label class="col-lg-2 control-label"><?php echo ($vo["title"]); ?></label>
                                                        <div class="col-lg-6">
                                                            <input type="text" id="markpath" class="form-control" name="<?php echo ($vo["name"]); ?>" placeholder="<?php echo ($vo["title"]); ?>" value="<?php echo ($vo["value"]); ?>">
                                                        </div>
                                                        <div class="col-lg-4"><button type="button" id="up" class="btn btn-s-md btn-default">上传图片</button></div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-sm-2"></div>
                                                        <div class="col-sm-10" id="markpic"><?php if($vo['value'] != ''): ?><img class="img-responsive thumb m-r-xs" src="<?php echo ($vo["value"]); ?>" alt="水印图" /><?php endif; ?></div>
                                                    </div>
                                                <?php else: ?>
                                                    <div class="form-group">
                                                        <label class="col-lg-2 control-label"><?php echo ($vo["title"]); ?></label>
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control" name="<?php echo ($vo["name"]); ?>" placeholder="<?php echo ($vo["title"]); ?>" value="<?php echo ($vo["value"]); ?>">
                                                        </div>
                                                        <div class="col-lg-4"></div>
                                                    </div><?php endif; break;?>
                                            <!--文本-->
                                            <?php case "2": ?><div class="form-group">
                                                    <label class="col-sm-2 control-label"><?php echo ($vo["title"]); ?></label>
                                                    <div class="col-sm-6">
                                                        <textarea class="form-control" name="<?php echo ($vo["name"]); ?>" rows="5" data-minwords="6" data-required="true" placeholder="<?php echo ($vo["title"]); ?>"><?php echo ($vo["value"]); ?></textarea>
                                                    </div>
                                                    <div class="col-lg-4"></div>
                                                </div><?php break;?>
                                            <!--枚举-->
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <div class="radio-inline pad-lf-none">
                                                            <label class="radio-custom margin-lf-none">
                                                                <input type="radio" name="<?php echo ($vo["name"]); ?>" value="1" <?php if($vo['value'] == 1): ?>checked="checked"<?php endif; ?>>
                                                                <i class="fa fa-circle-o"></i> 是 </label>
                                                        </div>
                                                        <div class="radio-inline pad-lf-none">
                                                            <label class="radio-custom margin-lf-none">
                                                                <input type="radio" name="<?php echo ($vo["name"]); ?>" value="0" <?php if($vo['value'] == 0): ?>checked="checked"<?php endif; ?>>
                                            ...
                                            <?php case "4": ?><div class="form-group">
                                                    <label class="col-sm-2 control-label"><?php echo ($vo["title"]); ?></label>
                                                    <div class="col-sm-6">
                                                        <textarea class="form-control" name="<?php echo ($vo["name"]); ?>" id="editor"><?php echo ($vo["value"]); ?></textarea>
                                                    </div>
                                                    <div class="col-lg-4"></div>
                                                </div><?php break;?>
                                            <!--默认-->
    ...
    <script type="text/javascript">
        ...
        $('#up').click(function(){
            layer.open({
                ...
                shade:0.8,
                area:['70%','60%'],
                content:'/excavator/index.php?s=/Admin/Up/mark',
            });
        });
    </script>
    <!-- fuelux -->
    ...
    <script src="/excavator/Public/Admin/js/config/index.js"></script>
