        ...
        if(IS_POST){
            ...
            if($data['action'] == 1){
                ...
                if($this->activity->delete($ids)){
                    $this->apiReturn(200,'批量删除成功',array('url'=>'index.php?s=Admin/Activity/index'));
                }else{
                ...
                $this->apiReturn(200,'批量推荐成功',array('url'=>'index.php?s=Admin/Activity/index'));
            }
        }else{
        ...
        if(IS_POST){
            ...
            if($this->activity->create($data)){
                if($this->activity->add()){
                    $this->apiReturn(200,'添加活动成功',array('url'=>'index.php?s=Admin/Activity/index'));
                }else{
        ...
        if(IS_POST){
            ...
            if($this->activity->create($data)){
                if($this->activity->save()){
                    $this->apiReturn(200,'修改活动成功',array('url'=>'index.php?s=Admin/Activity/index'));
                }else{
