...
class ArticleTypeController extends BaseController{
        ...
        if(IS_POST){
            ...
            if($data['action'] == 1){
                ...
                if($this->type->delete($ids)){
                    $this->apiReturn(200,'批量删除成功',array('url'=>'Admin/ArticleType/index'));
                }else{
                ...
                $this->apiReturn(200,'批量设置成功',array('url'=>'Admin/ArticleType/index'));
            }
        }else{
    ...
    public function add(){
        if(IS_POST){
            ...
            if($this->type->create($data)){
                if($this->type->add()){
                    $this->apiReturn(200,'新增文章类型成功',array('url'=>'Admin/ArticleType/index'));
                }else{
    ...
    public function edit(){
        if(IS_POST){
            ...
            if($this->type->create($data)){
                if($this->type->save()){
                    $this->apiReturn(200,'修改文章类型成功',array('url'=>'Admin/ArticleType/index'));
                }else{
