        ...
        if(IS_POST){
            ...
            if($data['action'] == 1){
                ...
                if($this->cate->delete($ids)){
                    ...
                    $memcache->clear();
                    $this->apiReturn(200,'批量删除成功',array('url'=>'index.php?s=Admin/Category/index'));
                }else{
                ...
                $memcache->clear();
                $this->apiReturn(200,'批量审核成功',array('url'=>'index.php?s=Admin/Category/index'));
            }
        }else{
        ...
        if(IS_POST){
            ...
            if($this->cate->create($data)){
                if($this->cate->add()){
                    $memcache=self::getMemcache();
                    $memcache->clear();
                    $this->apiReturn(200,'添加商品分类成功',array('url'=>'index.php?s=Admin/Category/index'));
                }else{
        ...
        if(IS_POST){
            ...
            if($this->cate->create($data)){
                if($this->cate->save()){
                    $memcache=self::getMemcache();
                    $memcache->clear();
                    $this->apiReturn(200,'修改商品分类成功',array('url'=>'index.php?s=Admin/Category/index'));
                }else{
