			...
			this.createCorePlug = function(){
				var params = {
					...
					onSuccess: function(file, response) {
                        ...
                        window.opener.document.getElementById('thumbpic').value+=response.data.thumb+';';
                        window.opener.document.getElementById('mainpic').value+=response.data.main+';';
                        window.opener.document.getElementById('thumb').innerHTML+='<a class="delpic" onclick="delPic(this);"><img class="img-responsive thumb m-r-xs" src="'+response.data.thumb+'" alt="缩略图" /><i class="fa fa-times text-danger text"></i></a>';
					},
